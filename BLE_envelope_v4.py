...
#MongoDB
uri = "mongodb+srv://jimiaoul:***@cluster0.rxwufw8.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0"
...
class RealTimePlotter:
    ...
    def plot_final_data(self):
        ...
        with open('random_leg_extension4.csv', 'w', newline='') as csvfile:
